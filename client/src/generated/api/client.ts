...
export const getCurrentUserEnrollments = (
  ...
  return CustomAxiosInstance<GetCurrentUserEnrollmentsResponseApiResponse>(
    {
      url: `http://localhost:4000/api/v1/enrollments/get-current-user-enrollments`,
      method: 'GET',
      signal,
    },
    options
...
export const getGetCurrentUserEnrollmentsQueryKey = () => {
  return [`http://localhost:4000/api/v1/enrollments/get-current-user-enrollments`] as const;
};
...
export const getGraduates = (
  ...
  return CustomAxiosInstance<GetGraduatesResponseApiResponse>(
    { url: `http://localhost:4000/api/v1/users/get-graduates`, method: 'GET', params, signal },
    options
  );
};

export const getGetGraduatesQueryKey = (params?: GetGraduatesParams) => {
  return [`http://localhost:4000/api/v1/users/get-graduates`, ...(params ? [params] : [])] as const;
};
