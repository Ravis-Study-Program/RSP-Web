...
namespace RSPWebAPI.Migrations
{
  ...
  public partial class RemoveMockInterviewNavigation : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.DropColumn(name: "MockInterviewId", table: "LeetcodeMockInterviewRound");
      ...
      migrationBuilder.DropColumn(name: "MockInterviewId", table: "CustomMockInterviewRound");

      migrationBuilder.DropColumn(name: "MockInterviewRoundId", table: "CustomMockInterviewRound");

      migrationBuilder.DropColumn(name: "MockInterviewId", table: "BehaviouralMockInterviewRound");
