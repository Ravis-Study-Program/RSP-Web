  ...
  public partial class AddDatabaseIntegrity : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          LeetcodeProblemCategoriesLeetcodeProblemCategoryId = table.Column<string>(
            type: "varchar(32)",
            nullable: false
          ),
          LeetcodeProblemEntityLeetcodeProblemId = table.Column<string>(
            type: "varchar(16)",
            nullable: false
          ),
        },
        ...
        {
          table.PrimaryKey(
            "PK_LeetcodeProblemCategoryMapping",
            x => new
            {
              x.LeetcodeProblemCategoriesLeetcodeProblemCategoryId,
              x.LeetcodeProblemEntityLeetcodeProblemId,
            }
          );
          table.ForeignKey(
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          MockInterviewId = table.Column<string>(
            type: "varchar(16)",
            maxLength: 32,
            nullable: false
          ),
          ...
          InterviewerUserId = table.Column<string>(
            type: "varchar(16)",
            maxLength: 32,
            nullable: false
          ),
          IntervieweeUserId = table.Column<string>(
            type: "varchar(16)",
            maxLength: 32,
            nullable: false
          ),
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ProblemAttemptId = table.Column<string>(
            type: "varchar(16)",
            maxLength: 32,
            nullable: false
          ),
          ...
          LeetcodeProblemId = table.Column<string>(
            type: "varchar(16)",
            maxLength: 32,
            nullable: true
          ),
          CustomProblemId = table.Column<string>(
            type: "varchar(16)",
            maxLength: 32,
            nullable: true
          ),
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          BehaviouralMockInterviewRoundId = table.Column<string>(
            type: "varchar(32)",
            nullable: false
          ),
        ...
        {
          table.PrimaryKey(
            "PK_BehaviouralMockInterviewRound",
            x => x.BehaviouralMockInterviewRoundId
          );
          table.ForeignKey(
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.DropTable(name: "LeetcodeProblemCategoryMapping");

      migrationBuilder.DropTable(name: "Mentorship");

      migrationBuilder.DropTable(name: "ProblemAttempt");

      migrationBuilder.DropTable(name: "LeetcodeProblemCategory");

      migrationBuilder.DropTable(name: "CustomProblem");

      migrationBuilder.DropTable(name: "MockInterviewRound");

      migrationBuilder.DropTable(name: "BehaviouralMockInterviewRound");

      migrationBuilder.DropTable(name: "CustomMockInterviewRound");

      migrationBuilder.DropTable(name: "LeetcodeMockInterviewRound");

      migrationBuilder.DropTable(name: "LeetcodeProblem");

      migrationBuilder.DropTable(name: "MockInterview");

      migrationBuilder.DropTable(name: "Problem");
