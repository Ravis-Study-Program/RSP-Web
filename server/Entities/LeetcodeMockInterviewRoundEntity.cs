...
public class LeetcodeMockInterviewRoundEntity : IBaseEntity, ISoftDelete
{
  [Required]
...
public class LeetcodeMockInterviewRoundEntityConfiguration
  : IEntityTypeConfiguration<LeetcodeMockInterviewRoundEntity>
{
  public void Configure(EntityTypeBuilder<LeetcodeMockInterviewRoundEntity> builder)
  {
    ...
    builder
      ...
      .IsRequired();
    builder
      .Property(x => x.ConfirmQuestionScore)
      .HasColumnName("ConfirmQuestionScore")
      .HasColumnType("int")
      .IsRequired();
    builder
      .Property(x => x.AlgorithmDesignScore)
      .HasColumnName("AlgorithmDesignScore")
      .HasColumnType("int")
      .IsRequired();
    builder
      .Property(x => x.ComplexityAnalysisScore)
      .HasColumnName("ComplexityAnalysisScore")
      .HasColumnType("int")
      .IsRequired();
    builder
      .Property(x => x.CodingScore)
