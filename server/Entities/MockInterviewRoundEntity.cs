...
public class MockInterviewRoundEntityConfiguration
  : IEntityTypeConfiguration<MockInterviewRoundEntity>
{
  public void Configure(EntityTypeBuilder<MockInterviewRoundEntity> builder)
  {
    ...
    // Fields
    builder
      .Property(x => x.MockInterviewRoundId)
    ...
    builder
      ...
      .IsRequired();
    builder
      .Property(x => x.IsReviewedByInterviewee)
      .HasColumnName("IsReviewedByInterviewee")
      .IsRequired();
    builder
      .Property(x => x.IntervieweeComment)
    ...
    builder
      ...
      .HasColumnType("varchar(16)");
    builder
      .Property(x => x.LeetcodeMockInterviewRoundId)
    ...
    builder
      .HasOne(x => x.BehaviouralMockInterviewRound)
      .WithOne()
    ...
    builder
      .HasOne(x => x.LeetcodeMockInterviewRound)
      .WithOne()
    ...
    builder
      .HasOne(x => x.CustomMockInterviewRound)
      .WithOne()
