    ...
    )
    {
      try
      {
        ...
        var existingMockInterview = await _dbContext
          .MockInterviews.Include(m => m.Enrollment)
          ...
          .FirstOrDefaultAsync(
            e => e.MockInterviewId == request.MockInterviewId,
            cancellationToken
          );
        if (
          existingMockInterview == null
          || (
        ...
        {
          var updatedRoundDto = request.MockInterviewRoundDtos.FirstOrDefault(dto =>
            dto.MockInterviewRoundId == round.MockInterviewRoundId
          );
          ...
          {
            round.BehaviouralMockInterviewRound.BehavioralScore = updatedRoundDto
          ...
          {
            round.LeetcodeMockInterviewRound.ConfirmQuestionScore = updatedRoundDto
              .LeetcodeMockInterviewRound
              .ConfirmQuestionScore;
            round.LeetcodeMockInterviewRound.AlgorithmDesignScore = updatedRoundDto
              .LeetcodeMockInterviewRound
              .AlgorithmDesignScore;
            round.LeetcodeMockInterviewRound.ComplexityAnalysisScore = updatedRoundDto
              .LeetcodeMockInterviewRound
              .ComplexityAnalysisScore;
            round.LeetcodeMockInterviewRound.CodingScore = updatedRoundDto
              .LeetcodeMockInterviewRound
              .CodingScore;
            round.LeetcodeMockInterviewRound.TestingScore = updatedRoundDto
              .LeetcodeMockInterviewRound
              .TestingScore;
          }
          ...
          if (updatedRoundDto.CustomMockInterviewRound != null)
          {
            ...
            round.CustomMockInterviewRound.Content = updatedRoundDto
